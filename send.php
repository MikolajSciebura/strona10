...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'kontakt.mstechpc@gmail.com';
    $mail->Password = 'owzc gexg blmh qowa'; // App Password
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;

    $mail->setFrom('kontakt.mstechpc@gmail.com', 'Formularz Strony');
    $mail->addAddress('kontakt.mstechpc@gmail.com');
